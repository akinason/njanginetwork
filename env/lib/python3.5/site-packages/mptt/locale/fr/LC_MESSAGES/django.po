...
#: env/lib/python3.5/site-packages/mptt/admin.py:89
#, python-format
msgid "Successfully deleted %(count)d items."
msgstr "%(count)d éléments on été supprimés avec succès"

#: env/lib/python3.5/site-packages/mptt/admin.py:102
#, python-format
msgid "Delete selected %(verbose_name_plural)s"
msgstr "Supprimer les %(verbose_name_plural)s sélectionnées"

#: env/lib/python3.5/site-packages/mptt/admin.py:145
msgid "title"
msgstr "titre"

#: env/lib/python3.5/site-packages/mptt/admin.py:179
msgid "Did not understand moving instruction."
msgstr "L'instruction de déplacement n'a pas été comprise."

#: env/lib/python3.5/site-packages/mptt/admin.py:187
msgid "Objects have disappeared, try again."
msgstr "Les objets ont disparu, essayez encore."

#: env/lib/python3.5/site-packages/mptt/admin.py:191
msgid "No permission"
msgstr "Pas de permission"

#: env/lib/python3.5/site-packages/mptt/admin.py:200
#, python-format
msgid "Database error: %s"
msgstr "Erreur de base de données : %s"

#: env/lib/python3.5/site-packages/mptt/admin.py:205
#, python-format
msgid "%s has been successfully moved."
msgstr "%s a été déplacé avec succès."

#: env/lib/python3.5/site-packages/mptt/admin.py:216
msgid "move node before node"
msgstr "déplacer le nœud avant ce nœud"

#: env/lib/python3.5/site-packages/mptt/admin.py:217
msgid "move node to child position"
msgstr "déplacer le nœud à une sous-position"

#: env/lib/python3.5/site-packages/mptt/admin.py:218
msgid "move node after node"
msgstr "déplacer le nœud après ce nœud"

#: env/lib/python3.5/site-packages/mptt/admin.py:219
msgid "Collapse tree"
msgstr "Condenser l'arborescence"

#: env/lib/python3.5/site-packages/mptt/admin.py:220
msgid "Expand tree"
msgstr "Étendre l'arborescence"

#: env/lib/python3.5/site-packages/mptt/admin.py:332
msgid "All"
msgstr "Tout"

#: env/lib/python3.5/site-packages/mptt/forms.py:63
msgid "First child"
msgstr "Premier enfant"

#: env/lib/python3.5/site-packages/mptt/forms.py:64
msgid "Last child"
msgstr "Dernier enfant"

#: env/lib/python3.5/site-packages/mptt/forms.py:65
msgid "Left sibling"
msgstr "Voisin de gauche"

#: env/lib/python3.5/site-packages/mptt/forms.py:66
msgid "Right sibling"
msgstr "Voisin de droite"

#: env/lib/python3.5/site-packages/mptt/forms.py:184
msgid "Invalid parent"
msgstr "Parent non valide"

#: env/lib/python3.5/site-packages/mptt/managers.py:522
msgid "Cannot insert a node which has already been saved."
msgstr "Impossible d'insérer un nœud qui a déjà été enregistré."

#: env/lib/python3.5/site-packages/mptt/managers.py:739
#: env/lib/python3.5/site-packages/mptt/managers.py:902
#: env/lib/python3.5/site-packages/mptt/managers.py:938
#: env/lib/python3.5/site-packages/mptt/managers.py:1104
#, python-format
msgid "An invalid position was given: %s."
msgstr "Une position non valide a été fournie : %s."

#: env/lib/python3.5/site-packages/mptt/managers.py:888
#: env/lib/python3.5/site-packages/mptt/managers.py:1084
msgid "A node may not be made a sibling of itself."
msgstr "Un nœud ne peut être voisin de lui-même."

#: env/lib/python3.5/site-packages/mptt/managers.py:1063
#: env/lib/python3.5/site-packages/mptt/managers.py:1181
msgid "A node may not be made a child of itself."
msgstr "Un nœud ne peut être son propre enfant."

#: env/lib/python3.5/site-packages/mptt/managers.py:1065
#: env/lib/python3.5/site-packages/mptt/managers.py:1183
...
#: env/lib/python3.5/site-packages/mptt/managers.py:1086
...
#: env/lib/python3.5/site-packages/mptt/models.py:301
msgid "register() expects a Django model class argument"
msgstr "register() s'attend à un paramètre de classe de modèle Django"

#: env/lib/python3.5/site-packages/mptt/templates/admin/mptt_filter.html:3
#, python-format
msgid " By %(filter_title)s "
msgstr " Par %(filter_title)s "

#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:31
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:55
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:62
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:89
#, python-format
msgid "%s tag requires three arguments"
msgstr "la balise %s requiert trois paramètres"

#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:91
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:146
#, python-format
msgid "second argument to %s tag must be 'as'"
msgstr "le second paramètre de la balise %s doit être « as »"

#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:143
#, python-format
msgid "%s tag requires either three, seven or eight arguments"
msgstr "la balise %s requiert trois, sept ou huit paramètres"

#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:150
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:154
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:160
#, python-format
msgid ""
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:164
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:168
#, python-format
...
#: env/lib/python3.5/site-packages/mptt/templatetags/mptt_tags.py:287
#, python-format
msgid "%s tag requires a queryset"
msgstr "la balise %s requiert un « queryset »"

#: env/lib/python3.5/site-packages/mptt/utils.py:247
#, python-format
