...
urlpatterns = [
    ...
    # url(r"^remuneration/create/$", name="remuneration_create"),
    # url(r"^remuneration/(?P<id>[0-9])/update/$", name="remuneration_update"),
    # url(r"^remuneration/(?P<id>[0-9])/beneficiary_list/$", name="beneficiary_list"),
    # url(r"^remuneration/(?P<id>[0-9])/transfer_funds/$", name="remuneration_funds_transfer"),
]
