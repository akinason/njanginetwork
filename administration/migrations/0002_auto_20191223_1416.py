# Generated by Django 2.0 on 2019-12-23 14:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_paid', models.BooleanField(default=False, verbose_name='is_paid')),
                ('status', models.IntegerField(choices=[('DRAFT', 'DRAFT'), ('GENERATED', 'GENERATED'), ('PAID', 'PAID'), ('PARTIALLY_PAID', 'PARTIALLY_PAID')], verbose_name='status')),
            ],
        ),
        migrations.AddField(
